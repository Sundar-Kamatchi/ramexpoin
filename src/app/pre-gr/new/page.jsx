...
export default function CreatePreGRPage() {
    ...
    useEffect(() => {
        ...
        const goodsWt = fromTotalKgs(goodsTotal);
        const nettWt = fromTotalKgs(netTotal);

        setGoodsWtTons(goodsWt.tons);
        setGoodsWtKgs(goodsWt.kgs);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const preGREntry = {
                ...
                gap_item1_bags: parseInt(gapItem1Bags) || 0,
                gap_item2_id: gapItem2Id,
                gap_item2_bags: parseInt(gapItem2Bags) || 0,
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mb-8">
                        ...
                        >
                            ...
                            {purchaseOrders.map((po) => (
                                <option key={po.id} value={po.id}>
                                    {po.vouchernumber} - {formatDateDDMMYYYY(po.date)} - {po.suppliers?.name || 'Unknown Supplier'}
                                </option>
                            ))}
                        </select>
                    </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Goods Weight</label>
                            <div className="flex gap-2">
                                <input
                                    type="text"
